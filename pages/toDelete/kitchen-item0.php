      ...
      <div class="row mt-3">
       ...
       <?php foreach ($item_list as $item):
         ...
         if ($item->isBestSeller) {
          ...
          ?>
          <div class="col-lg-4 mb-2 menu-item mt-3">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <?php if ($item->image): ?>
                ...
                <?php endif; ?>
                  <div class="col">
                    ...
                    <button type="button" name="button" onclick="open_modal('<?=$item->Id?>')" style="margin-bottom:-30px" data-bs-toggle="modal" data-bs-target="#itemModal<?=$item->Id?>">Markings</button>
